...
namespace TpLaboAutomóviles.Reportes.DataSet {
    ...
    public partial class DataSet3 : global::System.Data.DataSet {
        ...
        public partial class ProductosDataTable : global::System.Data.TypedTableBase<ProductosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductosRow AddProductosRow(string Producto, decimal Precio) {
...
namespace TpLaboAutomóviles.Reportes.DataSet.DataSet3TableAdapters {
    ...
    public partial class ProductosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Productos] WHERE (((@IsNull_Producto = 1 AND [descripcion] IS NULL) " +
                "OR ([descripcion] = @Original_Producto)) AND ((@IsNull_Precio = 1 AND [Precio] I" +
                "S NULL) OR ([Precio] = @Original_Precio)) AND ([idProducto] = @Original_idProduc" +
                "to))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Productos] ([descripcion], [Precio]) VALUES (@Producto, @Precio);\r\nS" +
                "ELECT descripcion AS Producto, precio AS Precio, idProducto FROM Productos WHERE" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Productos] SET [descripcion] = @Producto, [Precio] = @Precio WHERE (((@IsNull_Producto = 1 AND [descripcion] IS NULL) OR ([descripcion] = @Original_Producto)) AND ((@IsNull_Precio = 1 AND [Precio] IS NULL) OR ([Precio] = @Original_Precio)) AND ([idProducto] = @Original_idProducto));
SELECT descripcion AS Producto, precio AS Precio, idProducto FROM Productos WHERE (idProducto = @idProducto)";
        ...
        public virtual int Fill(DataSet3.ProductosDataTable dataTable, global::System.Nullable<decimal> xprecio) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((xprecio.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(xprecio.Value));
            }
            else {
        ...
        public virtual DataSet3.ProductosDataTable GetData(global::System.Nullable<decimal> xprecio) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((xprecio.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(xprecio.Value));
            }
            ...
            DataSet3.ProductosDataTable dataTable = new DataSet3.ProductosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet3.ProductosDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Producto, decimal Original_Precio, int Original_idProducto) {
        ...
        public virtual int Insert(string Producto, decimal Precio) {
            if ((Producto == null)) {
        ...
        public virtual int Update(string Producto, decimal Precio, string Original_Producto, decimal Original_Precio, int Original_idProducto, int idProducto) {
            if ((Producto == null)) {
                throw new global::System.ArgumentNullException("Producto");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Producto, decimal Precio, string Original_Producto, decimal Original_Precio, int Original_idProducto) {
            return this.Update(Producto, Precio, Original_Producto, Original_Precio, Original_idProducto, Original_idProducto);
        }
    }
